...
`wget -N https://raw.githubusercontent.com/henroFall/oscar2/dev/install_oscar.sh?token=AGEKZTD5SXMWYPZUNPCKSHK652IKM && mv install_oscar.sh?token=AGEKZTD5SXMWYPZUNPCKSHK652IKM install_oscar.sh && sudo chmod +x install_oscar.sh && sudo ./install_oscar.sh`
